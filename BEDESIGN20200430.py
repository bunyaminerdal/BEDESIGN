from PyQt5.QtWidgets import QDialog,QListWidget,QColorDialog,QFontDialog,QFileDialog,QCheckBox,QSpinBox,QDoubleSpinBox,QComboBox, QRadioButton, QAbstractItemView,QStyledItemDelegate,QItemDelegate,QWidget,QTableWidget,QTableWidgetItem,QVBoxLayout,QHBoxLayout,QApplication, QMainWindow, QMdiArea, QAction, QMdiSubWindow, QTextEdit,QOpenGLWidget,QMenu,QShortcut,QLabel,QLineEdit,QSpinBox,QDoubleSpinBox,QPushButton
import sys , os
...
import numpy as np
import math
from PyQt5.QtGui import QPainter, QColor, QFont,QWheelEvent, QIcon ,QPen ,QKeySequence,QCursor,QIntValidator,QDoubleValidator ,QValidator
...
class MaterialWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.listbox.setSelectionMode(3)
    ...
    def on_click_ok(self,event):
        if self.text1.text()!="" and self.text2.text()!="" and self.text3.text()!="" and self.text4.text()!="" and self.text5.text()!="" and self.text6.text()!="" :
            ...
            if mdi.sectiondlg.addsectionbool==False:
                ...
                if sum(y.get('name')==self.text1.text() and y.get('deleted')==False  for y in Sections.sectiondict)==0:
                    DLshape(self.sectionname,self.mat['index'],self.h,self.hthickness,self.b,self.bthickness,self.distance)
                    self.close()
                else:
                    self.text1.setStyleSheet("border: 1px solid red;")
    ...
    def on_click_ok(self,event):
        if self.text1.text()!="" and self.text2.text()!="" and self.text3.text()!="" and self.text4.text()!="" and self.text5.text()!=""  :
            ...
            if mdi.sectiondlg.addsectionbool==False:
                ...
                if sum(y.get('name')==self.text1.text() and y.get('deleted')==False  for y in Sections.sectiondict)==0:
                    Lshape(self.sectionname,self.mat['index'],self.h,self.hthickness,self.b,self.bthickness)
                    self.close()
                else:
                    self.text1.setStyleSheet("border: 1px solid red;")
...
class FrameSectionWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.listbox=QListWidget(self)
        self.listbox.setGeometry(20,20,170,135)
        self.listbox.setSelectionMode(1)
        self.listboxfiller()
                    ...
                    if frame['show'] and frame['deleted']==False:
                        ...
                        if frame['section']!='No Section':
                            ...
                            if framesection['type']=='ishape':
                                ...
                                glEnd()
                            elif framesection['type']=='lshape':
                                #######AĞIRLIK MERKEZİ###########
                                Ah1=framesection['h']*framesection['hthickness']
                                Ab1=(framesection['b']-framesection['hthickness'])*framesection['bthickness']
                                Ah2=(framesection['h']-framesection['bthickness'])*framesection['hthickness']
                                Ab2=framesection['b']*framesection['bthickness']
                                try:
                                    e2=((Ah1*framesection['hthickness']/2 )+(Ab1*((framesection['hthickness']+framesection['b'])/2)))/(Ah1+Ab1)
                                    e3=(framesection['h']/2)-(((Ab2*framesection['bthickness']/2 )+(Ah2*((framesection['bthickness']+framesection['h'])/2)))/(Ah2+Ab2))
                                    
                                except Exception as e:
                                    logging.debug(e)
                                    logging.info('divide 0,e2,e3')
                                ...
                                #ÜST BAŞLIK
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['hthickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['hthickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2)
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2)
                                ...
                                #alt başlık sağ yan alt
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3+extrudescale*(framesection['h']/2)-extrudescale*(framesection['bthickness']),jointcoord[2]+e2-extrudescale*(framesection['hthickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3+extrudescale*(framesection['h']/2)-extrudescale*(framesection['bthickness']),jointcoord[2]+e2-extrudescale*(framesection['hthickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3+extrudescale*(framesection['h']/2)-extrudescale*(framesection['bthickness']),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3+extrudescale*(framesection['h']/2)-extrudescale*(framesection['bthickness']),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                ...
                                glEnd()
                            elif framesection['type']=='dlshape':
                                #######AĞIRLIK MERKEZİ###########
                                Ah1=framesection['h']*framesection['hthickness']
                                Ab1=(framesection['b']-framesection['hthickness'])*framesection['bthickness']
                                Ah2=(framesection['h']-framesection['bthickness'])*framesection['hthickness']
                                Ab2=framesection['b']*framesection['bthickness']
                                try:
                                    e2=-(framesection['distance']/2)
                                    e3=(framesection['h']/2)-(((2*Ab2*framesection['bthickness']/2 )+(2*Ah2*((framesection['bthickness']+framesection['h'])/2)))/(2*Ah2+2*Ab2))
                                ...
                                glEnd()
                            elif framesection['type']=='rectangular':
                                #######AĞIRLIK MERKEZİ###########
                                ...
                                #üst başlık sağ yan alt
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                ...
                                #ÜST BAŞLIK                             
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                ...
                                ############################# ARKA YÜZ #################################33
                                #ÜST BAŞLIK                             
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                ...
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2)
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                # glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                # glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0],jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                ...
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2)
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                # glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                # glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2),jointcoord[2]+e2-extrudescale*(framesection['b']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['b'])+extrudescale*(framesection['thickness']))
                                glVertex3d(jointcoord[0]+framelength,jointcoord[1]-e3-extrudescale*(framesection['h']/2)+extrudescale*(framesection['thickness']),jointcoord[2]+e2-extrudescale*(framesection['thickness']))
                                ...
                                glEnd()
                            elif framesection['type']=='rectangularbar':
                                #######AĞIRLIK MERKEZİ###########
                                ...
                                glEnd()
                            elif framesection['type']=='circular':
                                circulardivide=20
                                glColor3ub(Variables.frameColor[0],Variables.frameColor[1],Variables.frameColor[2])
                                ...
                                glBegin(GL_QUADS)
                                ################################# DIŞ YÜZ ######################################
                                for i in range(circulardivide):
                                        angle = 2 * math.pi * i / circulardivide
                                        x = math.cos(angle)
                                        y = math.sin(angle)
                                        glVertex3d(jointcoord[0]+framelength,jointcoord[1]+extrudescale*(framesection['d']/2)*x,jointcoord[2]+extrudescale*(framesection['d']/2)*y)
                                        glVertex3d(jointcoord[0],jointcoord[1]+extrudescale*(framesection['d']/2)*x,jointcoord[2]+extrudescale*(framesection['d']/2)*y)

                                        angle = 2 * math.pi * (i+1) / circulardivide
                                        x = math.cos(angle)
                                        y = math.sin(angle)
                                        glVertex3d(jointcoord[0],jointcoord[1]+extrudescale*(framesection['d']/2)*x,jointcoord[2]+extrudescale*(framesection['d']/2)*y)
                                        glVertex3d(jointcoord[0]+framelength,jointcoord[1]+extrudescale*(framesection['d']/2)*x,jointcoord[2]+extrudescale*(framesection['d']/2)*y)
                                ...
                                for i in range(circulardivide):
                                        ...
                                        x = math.cos(angle)
                                        y = math.sin(angle)
                                        glVertex3d(jointcoord[0],jointcoord[1]+(extrudescale*(framesection['d']/2)-extrudescale*(framesection['thickness']))*x,jointcoord[2]+(extrudescale*(framesection['d']/2)-extrudescale*(framesection['thickness']))*y)
                                        glVertex3d(jointcoord[0]+framelength,jointcoord[1]+(extrudescale*(framesection['d']/2)-extrudescale*(framesection['thickness']))*x,jointcoord[2]+(extrudescale*(framesection['d']/2)-extrudescale*(framesection['thickness']))*y)
                                        angle = 2 * math.pi * (i+1) / circulardivide
                                        x = math.cos(angle)
                                        y = math.sin(angle)
                                        glVertex3d(jointcoord[0]+framelength,jointcoord[1]+(extrudescale*(framesection['d']/2)-extrudescale*(framesection['thickness']))*x,jointcoord[2]+(extrudescale*(framesection['d']/2)-extrudescale*(framesection['thickness']))*y)
                                ...
                                for i in range(circulardivide):
                                        ...
                                        glVertex3d(jointcoord[0]+framelength,jointcoord[1]+extrudescale*(framesection['d']/2)*x,jointcoord[2]+extrudescale*(framesection['d']/2)*y)
                                glEnd()
                            elif framesection['type']=='circularbar':
                                circulardivide=20
                                glColor3ub(Variables.frameColor[0],Variables.frameColor[1],Variables.frameColor[2])
                                #glBegin(GL_LINE_LOOP)
                                glEnable(GL_CULL_FACE)
